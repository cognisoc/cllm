...
CORE_C_FILES=("boot.S" "kernel.c" "allocator.c" "string.c" "safestring.c" "http.c" "api.c" "api_v1.c" "json.c" "c_model_interface.c" "network.c" "network/arp.c" "network/ip.c" "network/tcp.c" "network/pci.c" "network/e1000.c" "llm.c" "cuda_interface.c" "memory.c" "error.c" "model_embedding.c" "interrupts.c" "spinlock.c")
